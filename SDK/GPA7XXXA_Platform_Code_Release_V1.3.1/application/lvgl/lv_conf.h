...
#define LV_USE_GP_JPEG      0
#define LV_USE_GP_RAWIMG    0
...
#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE "gplib_mm_gplus.h"   /*Header for the dynamic memory function*/
    #define LV_MEM_CUSTOM_ALLOC   gp_malloc
    #define LV_MEM_CUSTOM_FREE    gp_free
    #define LV_MEM_CUSTOM_REALLOC gp_realloc
#endif     /*LV_MEM_CUSTOM*/
